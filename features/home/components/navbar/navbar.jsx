...
import { getNavLinks, isStaffRole } from './navbar.model'
    ...
    <header className={styles.navbarHeader}>
      ...
      <nav className="container">
        <div className={styles.navRow}>
            ...
            {user ? (
              <>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={onSignOut}
                  className="rounded-full border border-white/25 px-3 py-1.5 text-xs text-white/80 hover:bg-white/10 cursor-pointer"
                >
          ...
          <motion.button
            whileTap={{ scale: 0.92 }}
            className="rounded-full border border-white/30 p-2 text-white md:hidden cursor-pointer"
            ...
            >
              <div className="grid gap-4 text-base font-medium">
                ...
                <div className="border-t border-white/15 pt-4 mt-2 flex flex-col gap-3">
                  {user ? (
                    <button onClick={onSignOut} className="text-left text-sm text-white/70 cursor-pointer">Sign out</button>
                  ) : (
