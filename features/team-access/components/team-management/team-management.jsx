...
import { TeamManagementDefaults } from './team-management.model'
    ...
    <div className={styles.teamContainer}>
      ...
      <section className={styles.cardSection}>
        <div className="flex items-center gap-2">
          ...
          <p className="eyebrow">{TeamManagementDefaults.SUBTITLE}</p>
        </div>
        <h2 className="mt-2 font-serif text-2xl text-[#173d35]">{TeamManagementDefaults.CREATE_FORM_TITLE}</h2>
      ...
      <section className={styles.cardSection}>
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 font-serif text-2xl text-[#173d35]">{TeamManagementDefaults.TITLE}</h2>
            <p className="mt-1 text-sm text-slate-500">
