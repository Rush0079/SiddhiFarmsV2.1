...
function invoiceRows(booking) {
  ...
  const bookingTypeLabel = isEvent ? 'Event Reservation (1 Day)' : (isShortStay ? 'Day Use / Short Stay (4-5 Hours)' : (isDayTour ? 'Day Tour & Water Park' : 'Overnight Stay'))
  ...
  return [
    ...
    ...(isEvent ? [
      ...
      ['Short Stay Hours', `${displayTime(booking.check_in_time, '10:00')} to ${displayTime(booking.check_out_time, '15:00')} (Day Use)`],
      ['Duration', 'Same Day (4-5 Hours Slot)'],
    ] : isDayTour ? [
